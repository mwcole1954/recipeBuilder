...
class Ingredient(tkinter.LabelFrame, DragDrop, BaseRecipe):
    """Panel to hold the ingredient information for the recipe. Inherits from BaseMethods.
    ...
    def __init__(self, master, label_font, font, em_font, special_list=None):
        ...
        self.config(text="Ingredients", font=self.label_font)
        self.data_list = []
        self.label_list = []
        self.value_list = []
        self.font = font
    ...
    def __repr__(self):
        return f'Ingredient: {self.data_list} {self.label_list} {self.value_list}'
    ...
    def make_panel(self):
        ...
        # self.sf.bind_arrow_keys(self.master)
        ...
        for n, data in enumerate(self.data_list):
            ...
            ht = math.ceil(len(self.data_list[n].value) / (self.value_list[n]['width'] + 10))
            ...
            if self.label_list[n].cget("text").lower() in self.special_list:
                ...
                self.value_list[n].insert(1.0, f'{self.data_list[n].value[0].capitalize()}'
                                               f'{self.data_list[n].value[1:]}')
